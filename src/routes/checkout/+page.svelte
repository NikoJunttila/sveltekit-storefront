<script lang="ts">
	...
	//for multivendor you need to have this be array and select shipping method for each vendor
		...
		<div class="mx-auto max-w-screen-2xl px-4 py-8">
			<div class="flex items-center justify-between border-b border-gray-200 pb-8">
				...
				<div class="flex items-center space-x-2">
					<div class="rounded-full bg-lime-50 p-2 hidden sm:block">
						<svg
					...
					<span class="text-[11px] sm:text-sm font-medium text-gray-600 ml-2"
				...
				<div class="grid grid-cols-1 gap-x-8 gap-y-6 lg:grid-cols-12">
					...
					<div class="lg:col-span-5">
						<div class="sticky top-8 space-y-6">
							...
							/>
							<OrderSummary {order} {errorMessage} data={data.channel} />
						</div>
					</div>
				</div>
